...
<table>
    <c:forEach items="${taskList}" var="task">
        <c:if test="${projectName != task.project.name}">
            ...
            <tr>
                <th><h3>${task.project.name}</h3></th>
                <th colspan="3"><h3>- <a href="<c:url value="/tasks/leader/new/${task.project.id}"/>">Add New Task</a>
                    | <a href="<c:url value="/projects/leader/manageMembers/${task.project.id}"/>">Manage Members</a></h3>
                </th>
            </tr>
